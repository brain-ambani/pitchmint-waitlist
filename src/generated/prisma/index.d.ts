...
export namespace Prisma {
  ...
  */
  ...
  export type WaitlistOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "twitter" | "createdAt", ExtArgs["result"]["waitlist"]>
  ...
  interface WaitlistFieldRefs {
    ...
    readonly twitter: FieldRef<"Waitlist", 'String'>
  ...
  export type WaitlistWhereInput = {
    ...
    twitter?: StringNullableFilter<"Waitlist"> | string | null
  ...
  export type WaitlistScalarWhereWithAggregatesInput = {
    ...
    twitter?: StringNullableWithAggregatesFilter<"Waitlist"> | string | null
